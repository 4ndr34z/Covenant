...
namespace LemonSqueezy.Models.Mofos
{
    public class ReferenceAssembly : ISerializable<ReferenceAssembly>
    {
        ...
        [NotMapped, JsonIgnore, System.Text.Json.Serialization.JsonIgnore]
        public List<MofoTask> MofoTasks => MofoTaskReferenceAssemblies.Select(e => e.MofoTask).ToList();
    ...
    public class EmbeddedResource : ISerializable<EmbeddedResource>
    {
        ...
        [NotMapped, JsonIgnore, System.Text.Json.Serialization.JsonIgnore]
        public List<MofoTask> MofoTasks => MofoTaskEmbeddedResources.Select(e => e.MofoTask).ToList();
    ...
    public class ReferenceSourceLibrary : ISerializable<ReferenceSourceLibrary>
    {
        ...
        [NotMapped, JsonIgnore, System.Text.Json.Serialization.JsonIgnore]
        public List<MofoTask> MofoTasks => MofoTaskReferenceSourceLibraries.Select(e => e.MofoTask).ToList();
    ...
    public class MofoTaskReferenceSourceLibrary
    {
    ...
    public class MofoTaskReferenceAssembly
    {
        public int MofoTaskId { get; set; }
        public MofoTask MofoTask { get; set; }
    ...
    public class MofoTaskEmbeddedResource
    {
        public int MofoTaskId { get; set; }
        public MofoTask MofoTask { get; set; }
