...
namespace LemonSqueezy.Models.Mofos
{
    ...
    public class ImplantTemplate
    {
        ...
        public List<Mofo> Mofos { get; set; } = new List<Mofo>();
        ...
        private string StagerLocation
        {
            get
            {
                ...
                string dir = Common.LemonSqueezyDataDirectory + "Mofo" + Path.DirectorySeparatorChar + Utilities.GetSanitizedFilename(this.Name) + Path.DirectorySeparatorChar;
