...
namespace LemonSqueezy.Models.Launchers
{
    public class PowerShellLauncher : Launcher
    {
        ...
        public PowerShellLauncher()
        {
            ...
            this.Description = "Uses powershell.exe to launch a Mofo using [System.Reflection.Assembly]::Load()";
        ...
        public override string GetLauncher(string StagerCode, byte[] StagerAssembly, Mofo mofo, ImplantTemplate template)
        {
            ...
            this.PowerShellCode = PowerShellLauncherCodeTemplate.Replace("{{MOFO_IL_BYTE_STRING}}", this.Base64ILByteString);
